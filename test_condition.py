...
model = '/mnt/d/CheckPoints/more_better2/D_final.pth'
...
def get_opt():
    ...
    parser.add_argument("--dataroot", default=test_root)
    ...
    parser.add_argument('--tensorboard_dir', type=str, default='./find_tunings/test/con_tensorboard',
                        help='save tensorboard infos')
    parser.add_argument('--checkpoint_dir', type=str, default='./find_tunings/test/con_checkpoints',
                        help='save checkpoint infos')
    parser.add_argument('--tocg_checkpoint', type=str, default=model, help='tocg checkpoint')
